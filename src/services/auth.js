import { ref } from 'vue'
// auth (authentication)is a service which stores data and allows it to be used across different components
export function useAuth() {
    ...
    async function signup(data) {
        try{
            isAuthenticated.value = true  // to auto-login whoever has registered
